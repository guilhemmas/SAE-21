...
Thibault Garcia : Création des serveurs Web (Physique + Virtuel)
Moi : Configuration du routeur externe en physique.
```
### 08/04/2022 (tp):
```
...
### 15/04/2022 (td+tp):
```
Séances entièrement dédié au essais de la premiere version du firewall du MikroTik pour ce rendre à la fin avec, Philippe Pujas, que les paquets acceptés.  
# PHOTO
```
### 21/04/2022 (2 td):
```
Bug du routeur MikroTik n°17 même avec le reset + tout ce qui est adressage (1h40) puis ensuite reprise d’un nouveau routeur MikroTik n°2  à 0 donc nouvelle config du firewall.
# PHOTO
```
### 22/04/2022 (tp):
```
